...
?>
<h2>Перевод единиц ускорения</h2>
<?php
...
class Value{
    ...
    private $valsNames = array(
        "kms" => "Километров на секунду в квадрате",
        "ms" => "Метров на секунду в квадрате",
        "mms" => "Миллиметров на секунду в квадрате",
        "mis" => "Миль на секунду в квадрате"
    );
