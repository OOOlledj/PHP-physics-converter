...
?>
<h2>Перевод единиц плотности</h2>
<?php
...
class Value{
    ...
    private $valsNames = array(
        "kgm" => "Килограмм на метр кубический",
        "gm" => "Грамм на метр кубический",
        "gcm" => "Грамм на сантиметр кубический",
        "gml" => "Грамм на миллилитр",
        "mgml" => "Миллиграмм на миллилитр",
        "kgl" => "Килограмм на литр",
        "mgm" => "Миллиграмм на метр кубический",
        "gl" => "Грамм на литр",
