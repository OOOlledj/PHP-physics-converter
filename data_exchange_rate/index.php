...
?>
<h2>Перевод единиц скорости обмена данными</h2>
<?php
...
class Value{
    ...
    private $valsNames = array(
        "bs" => "Бит в секунду",
        "kbs" => "Килобит в секунду",
        "mbs" => "Мегабит в секунду",
        "gbs" => "Гигабит в секунду",
        "bts" => "Байт в секунду",
        "kbts" => "Килобайт в секунду",
        "mbts" => "Мегабайт в секунду",
        "gbts" => "Гигабайт в секунду",
    );
